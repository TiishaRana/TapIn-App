...
import { Link, useNavigate } from "react-router-dom"; // Changed to react-router-dom for Link
...
const LoginPage = () => {
  ...
  const nameNonce = useMemo(() => Math.random().toString(36).slice(2), []);
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // Smooth redirect based on onboarding status
        ...
        <div className="hidden lg:flex w-full lg:w-1/2 bg-primary/10 items-center justify-center">
          <div className="max-w-md p-8">
            ...
            <div className="text-center space-y-3 mt-6">
              <h2 className="text-xl font-semibold">{t("connectPartners")}
              </h2>
